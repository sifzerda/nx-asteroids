...
This is a rebuild and refactor of my first fullstack asteroids game into a serverless frontend app. The app was refactored from React to Next.js, and game engine was changed from Matter.js to Three.js. The mongoDB database of users was removed and styling was enhanced. 
...
- ~~next-auth~~
- Vercel 
- Connected to neon (yellow) PostgreSQL DB (currently unused)
...
This project is incomplete. Currently the highscores page is just for display, further development is needed to allow users to submit their scores.